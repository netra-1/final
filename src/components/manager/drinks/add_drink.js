...
//   }
  ...
  const handleClick = async (e) => {
    ...
    try {
      await axios
        .post("http://localhost:8000/admin/drink", data, config)
        .then((response) => {
                ...
                <div className="flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
                  ...
                  <div className="rounded-t bg-gray-50 mb-0 px-6 py-6 border-20">
                    <div className="text-center flex justify-between ">
                      <h6 className="text-blueGray-700 text-2xl font-bold">Add Drinks</h6>
                      <Link
                      ...
                      <div className="flex flex-wrap">
                        <div className="w-full lg:w-12/12 px-4">
                          <div className="relative w-full mb-3">
                            ...
                            <input
                              type="text" onChange={(e) => setDrinkName(e.target.value)}
                      ...
                      <div className="w-full lg:w-4/12 px-4 mt-3">
                          <div className="relative w-full mb-3">
                            ...
                            >
                              ...
                              <div class="flex">
                                  <div class="flex items-center mr-4">
                                      <input id="inline-radio" type="radio" value={true} name="inline-radio-group1" onChange={(e) => setImported(e.target.value)} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                      <label for="inline-radio" class="ml-2 text-sm font-medium text-blueGray-500">YES</label>
                                  </div>
                                  <div class="flex items-center mr-4">
                                      <input id="inline-2-radio" type="radio" value={false} name="inline-radio-group1" onChange={(e) => setImported(e.target.value)} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                      <label for="inline-2-radio" class="ml-2 text-sm font-medium text-blueGray-500">NO</label>
                                  </div>
                              </div>
                        </div>
